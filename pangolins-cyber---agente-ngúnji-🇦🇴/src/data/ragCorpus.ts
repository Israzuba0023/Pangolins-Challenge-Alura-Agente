...
export const RAG_KNOWLEDGE_CORPUS: KnowledgeChunk[] = [
  // --- 01_LEGISLACAO: LEI Nº 22/11 (PROTEÇÃO DE DADOS PESSOAIS DE ANGOLA) ---
  {
    ...
    content: `Artigo 1.º (Objecto): A presente lei estabelece o regime jurídico aplicável ao tratamento de dados pessoais de pessoas singulares, com o objectivo de garantir a protecção das suas liberdades fundamentais e dos seus direitos, nomeadamente o direito à reserva da intimidade da vida privada e familiar. Aplica-se a todas as pessoas colectivas (empresas e PMEs) operando em Angola ou que façam tratamento de dados com meios situados no território nacional.`,
  ...
  },
  {
    ...
    content: `Artigo 4.º (Princípios da Qualidade dos Dados): Os dados pessoais devem ser: a) Tratados de forma lícita e com respeito pelo princípio da boa-fé; b) Recolhidos para finalidades determinadas, explícitas e legítimas, não podendo ser posteriormente tratados de forma incompatível com essas finalidades; c) Adequados, pertinentes e não excessivos relativamente às finalidades para que são recolhidos; d) Exactos e, se necessário, actualizados; e) Conservados de forma a permitir a identificação dos seus titulares apenas durante o período necessário para a prossecução das finalidades.`,
  ...
  },
  {
    ...
    content: `Artigo 11.º (Legitimação do Tratamento): O tratamento de dados pessoais só pode ser efectuado se o titular dos dados tiver dado de forma inequívoca o seu consentimento, ou se o tratamento for necessário para: a) A execução de um contrato no qual o titular seja parte; b) O cumprimento de obrigação legal a que o responsável pelo tratamento esteja sujeito (ex: obrigações fiscais junto da AGT em Angola); c) A protecção de interesses vitais do titular dos dados.`,
  ...
  },
  {
    ...
    content: `Artigo 12.º (Dados Sensíveis): É proibido o tratamento de dados pessoais relativos a convicções filosóficas ou políticas, filiação partidária ou sindical, religião, vida privada, origem racial ou étnica, bem como o tratamento de dados relativos à saúde e à vida sexual, incluindo dados genéticos. Excepções exigem autorização expressa prevista em lei ou autorização prévia da APD (Agência de Proteção de Dados).`,
  ...
  },
  {
    ...
    content: `Artigo 28.º (Segurança do Tratamento): O responsável pelo tratamento (empresa/PME) deve pôr em prática as medidas técnicas e organizativas adequadas para proteger os dados pessoais contra a destruição acidental ou ilícita, a perda acidental, a alteração, a difusão ou o acesso não autorizados. As medidas devem assegurar um nível de segurança adequado aos riscos que o tratamento apresenta e à natureza dos dados a proteger (ex: cifragem, backups, controlo de acessos, antivírus).`,
  ...
  },
  {
    ...
    content: `Artigo 30.º (Obrigação de Notificação à APD): O responsável pelo tratamento de dados ou o seu representante deve notificar previamente a APD (Agência de Proteção de Dados) antes da realização de qualquer tratamento de dados pessoais, salvo nos casos de isenção previstos pela lei. A notificação inclui as categorias de dados, finalidades, destinatários e medidas de segurança adoptadas. Tratamentos de dados sensíveis exigem autorização prévia formal da APD.`,
  ...
  },
  {
    ...
    content: `Artigo 40.º a 45.º (Sanções e Coimas): O incumprimento das obrigações de notificação, falta de medidas de segurança, ou violação dos direitos dos titulares sujeita as PMEs e empresas em Angola a sanções administrativas, coimas substanciais aplicadas pela APD e responsabilidade civil/penal. As coimas podem ser agravadas em caso de reincidência ou negligência grave.`,
  ...
  // --- 02_APD: DIRETRIZES DA AGÊNCIA DE PROTEÇÃO DE DADOS DE ANGOLA ---
  {
    ...
    content: `Orientações da APD para PMEs Angolanas: Todas as pequenas e médias empresas em Angola que possuam ficheiros informatizados ou físicos com dados de trabalhadores (recursos humanos), clientes (gestão de vendas/faturação), fornecedores ou CCTV (videovigilância) têm a obrigação legal de registar esses ficheiros junto da APD (www.apd.ao). O processo de declaração requer preenchimento de formulários detalhando medidas de segurança física e lógica, finalidade e prazos de conservação.`,
  ...
  },
  {
    ...
    content: `Em caso de violação de segurança de dados pessoais (ex: ataque de ransomware, roubo de computador com base de dados de clientes, e-mail enviado por engano para destinatários em massa, acesso não autorizado), a PME deve: 1) Isolar os sistemas afetados; 2) Documentar a causa e extensão da fuga; 3) Notificar a APD sem demora injustificada com relatório preliminar em até 72 horas; 4) Caso a violação represente um alto risco para os titulares dos dados, notificar os próprios afetados com recomendações de proteção.`,
  ...
  // --- 03_DPO: ENCARREGADO DE PROTEÇÃO DE DADOS (EPD / DPO) ---
  {
    ...
    content: `Funções do Encarregado de Proteção de Dados (EPD / DPO) em PMEs Angolanas: 1) Informar e aconselhar a administração e funcionários sobre as obrigações da Lei 22/11; 2) Monitorizar a conformidade com as políticas internas e a legislação de dados; 3) Ser o ponto de contacto oficial com a Agência de Proteção de Dados (APD); 4) PMEs que não têm capacidade financeira para contratar um DPO a tempo inteiro podem designar um DPO externo (DPO as a Service) ou atribuir acumulativamente a função a um gestor interno, desde que não haja conflito de interesses (ex: o Diretor de TI ou Diretor Financeiro não devem ser DPO do seu próprio trabalho).`,
  ...
  },
  {
    ...
    content: `Avaliação de Impacto sobre a Proteção de Dados (DPIA): É um estudo de risco obrigatório quando um novo tratamento de dados utilizar novas tecnologias ou envolver dados em grande escala / sensíveis (ex: biometria para ponto de funcionários, sistemas de rastreio GPS, aplicações bancárias ou de saúde). O relatório de DPIA avalia a necessidade, a proporcionalidade e os riscos para os direitos dos cidadãos, sugerindo controlos de mitigação antes do lançamento do sistema.`,
  ...
  // --- 04_CYBERSECURITY: PHISHING, PASSWORDS, MFA, BACKUPS & RANSOMWARE ---
  {
    ...
    content: `Prevenção contra Phishing e Burlas Informáticas em Angola: Phishing é a causa nº 1 de invasões e roubo de credenciais bancárias/e-mails corporativos em PMEs em Luanda e restantes províncias. 
...
4) Treinar a equipa quinzenalmente simulando exemplos reais de e-mails suspeitos.`,
  ...
  },
  {
    ...
    content: `Política de Senhas e Autenticação Multi-Fator (MFA):
...
4) Ativação OBRIGATÓRIA de MFA (2FA / Autenticação em 2 Etapas) no Google Workspace, Microsoft 365, e-mail institucional e sistemas de faturação. O MFA previne até 99% dos ataques de invasão de conta via credenciais roubadas.`,
  ...
  },
  {
    ...
    content: `Regra de Backup 3-2-1 para Proteção contra Ransomware:
...
Testar a restauração de ficheiros mensalmente.`,
  ...
  },
  {
    ...
    content: `Plano de Emergência em Caso de Invasão ou Ransomware na PME:
...
Passo 5 (Recuperação): Formatar equipamento afetado e restaurar dados a partir de backup limpo verificado.`,
  ...
  // --- 05_STANDARDS & COMPLIANCE FOR ANGOAN PMES ---
  {
    ...
    content: `Estrutura do NIST CSF 2.0 para Pequenas Empresas:
...
6) Recuperação (RECOVER): Saber restaurar os ficheiros a partir dos backups sem perder faturação.`,
  ...
  },
  {
    ...
    content: `Lei nº 23/11 dos Crimes Tecnológicos em Angola: Criminaliza o acesso ilegítimo a sistemas informáticos, a interceção ilícita de dados, a falsificação informática, o dano informático, a introdução de vírus/malware e a burla informática (phishing/engenharia social). As vítimas de crimes cibernéticos em Angola podem e devem apresentar queixa junto dos órgãos de investigação criminal (SIC - Serviço de Investigação Criminal) e munir-se de relatórios técnicos de evidência.`,
